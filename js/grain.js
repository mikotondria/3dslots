...
uniform float iTime;
vec2 iResolution = vec2(800.0);   //<---------- Kinda the graininess/rng seed PLAY WITH THIS
...
export default class GrainShader {
  constructor(THREE) {
    this.grainShader = new THREE.ShaderMaterial({
      ...
      transparent: false,                  //<---------- Toggling this does Weird. PLAY WITH THIS disable/enable etc.
      depthTest:false,
      depthWrite:false,
